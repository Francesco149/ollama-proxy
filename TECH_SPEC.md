...
### Module Breakdown
- `proxy.py`: Main entry point. Handles basic Ollama API routing and version checks.
- `skill_engine.py`: 
...
1. **Phase 1: Extraction.** Move vision and tool logic into standalone modules.
...
- Must follow the "Interface-First" principle to ensure modules are easily testable.# TECH_SPEC.md: ollama-proxy Refactor
